declare namespace window {
  namespace math {
     ...
     * @param y2 `f32`
     * @param length `f32`
     * @param out `assembly/index/Point`
     * @returns `assembly/index/Point`
     */
    export declare function getRightAngleSide(x1: number, y1: number, x2: number, y2: number, length: number, out?: __Internref5): __Internref5;
    /**
     ...
     * @returns `assembly/index/Point`
     */
    export declare function getLinePoint(x1: number, y1: number, x2: number, y2: number, length: number, out?: __Internref5): __Internref5;
    /**
     ...
     * @returns `assembly/index/Point`
     */
    export declare function getLinePointByAngle(x: number, y: number, length: number, angle: number, out?: __Internref5): __Internref5;
    /**
     ...
     * @returns `assembly/index/Point`
     */
    export declare function getLinePointByAngleExact(x: number, y: number, length: number, angle: number, out?: __Internref5): __Internref5;
    /**
    ...
    /** assembly/index/Point */
    class __Internref5 extends Number {
