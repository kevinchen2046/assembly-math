async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    ...
    getRightAngleSide(x1, y1, x2, y2, length, out) {
      // assembly/index/getRightAngleSide(f32, f32, f32, f32, f32, assembly/index/Point) => ~lib/typedarray/Float32Array
      out = __lowerRecord5(out) || __notnull();
      return __liftTypedArray(Float32Array, exports.getRightAngleSide(x1, y1, x2, y2, length, out) >>> 0);
    },
...
window.wasm = { debug: { instantiate: instantiate } };
